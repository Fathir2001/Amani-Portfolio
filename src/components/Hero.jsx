      ...
      <div className="max-w-6xl mx-auto px-5 pt-28 pb-12 md:pt-32 md:pb-16 w-full">
        <div className="grid lg:grid-cols-[0.95fr_1.05fr] gap-10 xl:gap-14 items-center">
          <div>
            ...
            >
              <span className="text-primary-purple text-xs font-bold tracking-[0.2em] uppercase">01 / Portfolio</span>
              <span className="h-px flex-1 max-w-32 bg-border-soft" />
              <span className="text-text-muted text-xs font-semibold uppercase tracking-[0.16em]">Sri Lanka</span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="section-title text-5xl md:text-6xl xl:text-7xl leading-[1.02] max-w-3xl"
            >
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a href="#contact" className="outline-btn px-6 py-3.5 text-sm font-semibold">
                  Contact
                </a>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="mt-9 grid grid-cols-3 divide-x divide-border-soft border-y border-border-soft max-w-xl"
            >
              {[
                ...
                <div key={item.label} className="py-4 px-4 first:pl-0">
                  <p className="section-title text-2xl md:text-3xl text-primary-dark">{item.value}</p>
                  <p className="text-text-muted text-xs font-semibold uppercase tracking-[0.12em] mt-1">{item.label}</p>
                </div>
              ))}
            </motion.div>
          </div>
